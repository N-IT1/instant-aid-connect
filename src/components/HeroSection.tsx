    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm animate-fade-in">
            <span className="text-sm font-medium text-white uppercase tracking-wider">
              Emergency Response Reimagined
            </span>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight tracking-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <Button
              size="lg"
              className="bg-accent hover:bg-coral-hover text-white text-lg px-8 py-7 h-auto shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
            >
              Get Involved
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 py-7 h-auto border-2 border-white/20 text-white bg-white/5 hover:bg-white/10 hover:border-white/40 w-full sm:w-auto transition-all duration-300"
            >
          ...
          <div className="mt-16 pt-8 border-t border-white/10 grid grid-cols-3 gap-8 text-center animate-fade-in opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.6s' }}>
            <div>
